...
```bash
php bin/console importmap:require datatables.net datatables.net-bs5 datatables.net-responsive-bs5
touch assets/controllers/datatable_controller.js
```

```js
// Fichier assets/controllers/datatable_controller.js
...
```bash
php bin/console importmap:require jquery moment daterangepicker/daterangepicker.css daterangepicker/daterangepicker.js
touch assets/controllers/daterange_controller.js
```

```js
// Fichier assets/controllers/daterange_controller.js
...
```bash
php bin/console make:form DateRange
```

```php
// Fichier src/Form/Type/DateRangeType.php
